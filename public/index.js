...
form.addEventListener("submit", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(event) {
    var username, email, date_of_birth, res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          _context.p = 1;
          _context.n = 2;
          return _axios.default.post("/api/v1/user/register", {
            username: username,
            email: email,
        ...
        case 3:
          _context.p = 3;
          _t = _context.v;
          document.getElementById("errorMsg").textContent = _t.response.data.message || "Something went wrong";
          console.log(_t.response.data);
        case 4:
          return _context.a(2);
      }
    }, _callee, null, [[1, 3]]);
